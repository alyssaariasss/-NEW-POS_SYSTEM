...
{
    public partial class _6janitor : Form
    {
        static MongoClient client = new MongoClient();
        static IMongoDatabase db = client.GetDatabase("POSLoginDB");
        static IMongoCollection<manager> collection = db.GetCollection<manager>("Janitor");
        ...
        private void _6janitor_Load(object sender, EventArgs e)
        {
            timer1.Start();
        }
    }
