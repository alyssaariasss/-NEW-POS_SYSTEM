...
{
    public partial class _3slsassociate : Form
    {
        static MongoClient client = new MongoClient();
        static IMongoDatabase db = client.GetDatabase("POSLoginDB");
        static IMongoCollection<manager> collection = db.GetCollection<manager>("SalesAssct");
        ...
        private void _3slsassociate_Load(object sender, EventArgs e)
        {
            timer1.Start();
        }
    }
